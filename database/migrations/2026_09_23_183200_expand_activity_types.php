...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        DB::statement('ALTER TABLE activities DROP CONSTRAINT IF EXISTS activities_type_check');
        DB::statement("ALTER TABLE activities ADD CONSTRAINT activities_type_check CHECK (type IN ('lead_created', 'lead_assigned', 'stage_changed', 'note_added', 'lead_updated'))");
    }
};
